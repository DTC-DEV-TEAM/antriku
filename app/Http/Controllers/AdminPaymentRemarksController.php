<?php namespace App\Http\Controllers;
	...
	class AdminPaymentRemarksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ['label'=>'Created At','name'=>'created_at','validation'=>'required|date','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Updated At','name'=>'updated_at','validation'=>'required|date','width'=>'col-sm-9'];
			# OLD END FORM
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
			DB::table('payment_remarks')->update([
