        ...
        <form method="post" action="{{CRUDBooster::mainpath('add-transaction-process')}}" id="SubmitTransactionForm">
            ...
            <div class="panel-body">
                <div class="form-group"> 
                    ...
                    <br>
                    <div class="row"> 
                        <label class="require control-label col-md-2"><span class="requiredField">*</span>Repair Strategy:</label>
                        <div class="col-md-3">
                            <label class="radio-inline control-label "><input type="radio" name="repair_strategy" value="MAIL-IN"  required>MAIL-IN</label>
                            <br>
                        </div>
                        <div class="col-md-3">
                            <label class="radio-inline control-label "><input type="radio" name="repair_strategy" value="CARRY-IN" required>CARRY-IN</label>
                            <br>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <br>
                            <div class="row">
                                <label class="control-label col-md-4" style="margin-top:7px;"><span class="requiredField">*</span>Device Issue:</label>
                                <div class="col-md-8">
                                    <textarea placeholder="Type customer explanation" name="device_issue" rows="3" class="form-control" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
