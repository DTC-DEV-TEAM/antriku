...
<script type="text/javascript">
    ...
    // Diagnostic Result
    $('#other_problem_details_other').hide();
    // $('#other_problem_details_other').removeAttr('required');
    // $('#other_problem_details').removeAttr('required');
    function diagnosticOtherProblemDetail()
    {
        var select_button_text = $('#other_problem_details option:selected')
                .toArray().map(item => item.text).join();
        let others = select_button_text.includes('OTHERS');


        if (others == true){
            $('#other_problem_details_other').show();
            // $('#other_problem_details_other').attr("required", true);
        }else{
            $('#other_problem_details_other').hide();
            $('#ftpd').text(null)
            // $('#other_problem_details_other').removeAttr('required');
        ...
        if(proceed){
            ...
            ({ 
                ...
                {   
                    ...
                    }else if(status_id == 'save_technician'){
                        $(".buttonSubmit").removeAttr("disabled");
                        swal({ title: "Success!", text: "Technician Saved.", type: "success"
                        }, function(){
                           location.reload();
                        });
                    }
