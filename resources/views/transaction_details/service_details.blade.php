            ...
            <div class="table-responsive">
                <table class="table table-bordered-display">
                    <tbody>
                        ...
                        @if ($transaction_details->device_issue != null)
                            <tr>
                                <td class="table-bordered-display" style="padding: 5px !important;">
                                    <label class="control-label col-md-12" style="margin-top:7px;">Device Issue:</label>
                                </td>
                                <td class="table-bordered-display" style="padding: 5px !important;" colspan="2">
                                    <div class="col-md-12" style="margin-top:7px;">{{ $transaction_details->device_issue }}</div>
                                </td>
                            </tr>
                        @endif
                    </tbody>
