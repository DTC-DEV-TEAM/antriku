    ...
    <div class="col-md-12">
        ...
        @if($transaction_details->repair_status == 1 && CRUDBooster::getModulePath() == "to_diagnose" && request()->segment(3) == "edit")
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3" style="margin-top:7px;">
                        <label><span class="requiredField">*</span> Mail-in/Carry-in:</label>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="mc_in" value="MAIL-IN" required {{ $transaction_details->technician_mc_in == 'MAIL-IN' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}}><strong>MAIL-IN</strong></label>
                        <br>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="mc_in" value="CARRY-IN" required {{ $transaction_details->technician_mc_in == 'CARRY-IN' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}} ><strong>CARRY-IN</strong></label>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3" style="margin-top:7px;">
                        <label><span class="requiredField">*</span> WUR/SUR:</label>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="wur_sur" value="WUR" required {{ $transaction_details->wur_sur == 'WUR' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}} ><strong>WUR</strong></label>
                        <br>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="wur_sur" value="SUR" required {{ $transaction_details->wur_sur == 'SUR' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}} ><strong>SUR</strong></label>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3" style="margin-top:7px;">
                        <label><span class="requiredField">*</span> Requote:</label>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="requote" value="YES" required {{ $transaction_details->requote == 'YES' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}} ><strong>YES</strong></label>
                        <br>
                    </div>
                    <div class="col-md-3" style="margin-top:7px;">
                        <label class="radio-inline control-label"><input type="radio" name="requote" value="NO" required {{ $transaction_details->requote == 'NO' ? 'checked' : ''}} {{ $transaction_details->repair_status != 1 ? 'disabled' : ''}} ><strong>NO</strong></label>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <label class="control-label col-md-2" style="margin-top:7px;"><span class="requiredField">*</span>GSX#:</label>
                    <div class="col-md-10" style="margin-top:7px;">
                        <input type="text" class="form-control" name="gsx_no" value="{{$transaction_details->gsx_no}}" placeholder="Type the GSX number" {{ $transaction_details->repair_status != 1 ? 'disabled' : '' }}>
                    </div>
                </div>
            </div>
            <br>
